...
export const metadata: Metadata = {
  title: "Candidate Reviews — Eumanai",
  description:
    "World-class talent loves Eumanai. Hear reviews from professionals who’ve applied, interviewed with Zuri, and joined roles through our network.",
};
