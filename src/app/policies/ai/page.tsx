...
export const metadata = {
  title: "AI Use Policy — Euman Intelligence",
  description: "How Euman Intelligence manages responsible and ethical use of AI.",
};
    ...
    <div className="max-w-2xl mx-auto py-12 px-4">
      ...
      <ul className="list-disc pl-6 text-gray-700">
        <li>
          ...
          <a href="mailto:proposals@eumanai.com" className="underline">
